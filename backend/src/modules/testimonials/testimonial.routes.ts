...
import { getAllTestimonials, getTestimonialById, createTestimonial, updateTestimonial, deleteTestimonial } from "./testimonial.controller";
...
export default async function testimonialRoutes(app: FastifyInstance): Promise<void> {
  ...
  app.put<{ Params: TestimonialIdParam; Body: UpdateTestimonialBody }>("/testimonials/:id", updateTestimonial);
